      ...
      <div className="w-full max-w-lg p-8 bg-[rgb(37,0,91)] rounded-lg shadow-lg flex flex-col items-center">
        <div className="flex flex-col sm:flex-row justify-center items-center mb-8">
          <div className="relative flex">
            <Image
              src="https://cdn.prod.website-files.com/67c6a0977d7e6cb3e65373c8/67c6a0987d7e6cb3e653740e_Small%20portrait%2011.png"
              alt="User 2"
              width={50}
              height={50}
            ...
            />
            <Image
              src="https://cdn.prod.website-files.com/67c6a0977d7e6cb3e65373c8/67c6a0987d7e6cb3e653740d_Small%20portrait%2010.png"
              alt="User 1"
              width={50}
              height={50}
        ...
        Sign up to start{' '}
          <span
            ...
            style={{
              backgroundImage: "url('https://cdn.prod.website-files.com/67c6a0977d7e6cb3e65373c8/67c6a0987d7e6cb3e6537414_Vector%201.png')",
