...
const testimonials = [
  {
    ...
    companyLogo: "/path/to/zomato.jpg", // Replace with actual logo path
  },
  {
    text: "SolveHire AI transformed our recruitment process. The AI-driven insights are game-changing!",
    author: "Anita Sharma - HR Head",
    imageUrl: "/path/to/image2.jpg", // Replace with actual image path
    companyLogo: "/path/to/swiggy.jpg", // Replace with actual logo path
  }
];
