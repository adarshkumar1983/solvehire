...
//             type="submit"
//             disabled={loading}
//             className="mt-4 w-full text-white font-bold bg-blue-500 rounded-md py-3 px-6 hover:bg-blue-600 transition duration-300"
//           >
    ...
    <div className="w-full h-1/2 flex justify-center items-center bg-[rgb(37,0,91)] text-white">
      ...
      <div className="w-full max-w-xl p-8 mt-20 mb-20 bg-[rgb(37,0,91)] rounded-lg shadow-lg flex flex-col items-center">
        ...
        <Link href="/contact" className="w-full">
          <span className="mt-4 w-full text-white font-bold bg-blue-500 rounded-md py-3 px-6 hover:bg-blue-600 transition duration-300 block text-center">
            Sign up
          </span>
        </Link>
